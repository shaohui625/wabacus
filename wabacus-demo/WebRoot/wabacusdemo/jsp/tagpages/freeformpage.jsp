...
%>			
				...
				<table width="100%" border="0" cellspacing="3" style="border:1px solid #ACCCFF;BORDER-COLLAPSE:collapse;">
				  ...
				  <tr>
					...
					<td align="left" style="border:1px solid #BDDFFF;">婚否：<select id="id_report1marriage" <%if(!report1_sex.equals("1")) out.println("disabled");%>>
					...
					<td align="left" style="border:1px solid #BDDFFF;">年龄：<input type="text" id="id_report1age" <%if(!report1_sex.equals("1")) out.println("disabled");%> value="<%=report1_age%>"> </td>
				  </tr>
				  <tr>
					...
					<td align="left" colspan="2" style="border:1px solid #BDDFFF;">工资：<input type="text" id="id_report1salary" <%if(!report1_sex.equals("0")) out.println("disabled");%> value="<%=report1_salary%>"> </td>
				  </tr>
				  <tr>
