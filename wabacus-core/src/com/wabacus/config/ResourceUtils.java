...
/**
 * 资源加载工具类：用于从类路径/文件系统/URL中加载资源文件
...
public final class ResourceUtils
{
    ...
    public static <T> Class<T> loadClass(String strClass) throws ClassNotFoundException{
        return (Class<T>)getClassLoader().loadClass(strClass);
    }
}
