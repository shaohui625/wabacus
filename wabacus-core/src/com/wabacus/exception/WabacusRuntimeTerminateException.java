...
public class WabacusRuntimeTerminateException extends RuntimeException
{
    ...
    public WabacusRuntimeTerminateException(String message)
    {
        super(message);

    }

    public WabacusRuntimeTerminateException(Throwable t)
    {
        super(t);
        mRootCause=t;
    }

    public WabacusRuntimeTerminateException(String mess,Throwable t)
    {
        super(mess,t);
        mRootCause=t;
    }
