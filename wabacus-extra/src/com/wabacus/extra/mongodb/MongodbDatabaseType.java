...
public class MongodbDatabaseType extends AbstractNoSqlDatabaseType {
    /**
     * Logger for this class
     */
    private static final Logger LOG = LoggerFactory.getLogger(MongodbDatabaseType.class);
    ...
    public void doPostLoadSql(ReportDataSetValueBean sbean, boolean isListReportType) {
        ...
        if (orderBy instanceof Map) {
            orderBy = MongoExprContext.toJson(orderBy);
        }
    ...
    public void updateData(Map<String, String> mParamsValue, Map<String, String> mExternalParamsValue,
        ...
        final MongoExprContext ctx = createExprContext(rrequest, rbean, null);
        Map vars = new HashMap();
        ...
        final Object eval = MongodbDatabaseType.eval(actionBean.getSql(), vars, ctx);
        vars.clear();
    ...
    private ISQLTypeCreatorMongo defaultCreator = new ISQLTypeCreatorMongo();
    ...
    public static MongoExprContext eval(String sql, ReportRequest rrequest, ReportBean rbean,
            ReportDataSetValueBean datasetbean) {
        return eval(sql, null, rrequest, rbean, datasetbean);
    }

    public static MongoExprContext eval(String script, Map vars, MongoExprContext ctx) {
        if (Config.show_sql) {
    ...
    public static MongoExprContext eval(String script, Map vars, ReportRequest rrequest, ReportBean rbean,
            ReportDataSetValueBean datasetbean) {
        if (null == vars) {
            vars = new HashMap();
        }
        final MongoExprContext ctx = createExprContext(rrequest, rbean, datasetbean);
        return eval(script, vars, ctx);
    }

    private static final MongoExprContext createExprContext(ReportRequest rrequest, ReportBean rbean,
            ReportDataSetValueBean datasetbean) {
        final MongoExprContext ctx = (MongoExprContext)WabacusScriptEngineHelper
                .getScriptExprContextFactory().createScriptExprContext(MongodbDatabaseType.class,rrequest, rbean, datasetbean);
        return ctx;
    }
