...
public   class DbUtilsBeanProcessor {
	...
	/**
	 * Constructor for DbUtilsBeanProcessor configured with column to property name
	 * overrides.
	 * 
	 ...
	 * @since 1.5
	 */
	public DbUtilsBeanProcessor(Map<String, String> columnToPropertyOverrides) {
		super();
	...
	private void callSetter(Object target, PropertyDescriptor prop, Object value)
		...
		try {
			...
			if(value!=null&& "oracle.sql.TIMESTAMP".equals(value.getClass().getName())){
				value = MethodUtils.invokeMethod(value, "timestampValue", ArrayUtils.EMPTY_OBJECT_ARRAY);	
			}
